...
#Versão 3 Corrige instalação do Firebird para todos os usuários no Ubuntu 20.+
...
function instalar_syshosp(){
	...
	echo -e "\nInstale manualmente o 
	."
	#Executa o instalador do Firebird
	su - sti -c "cp /mnt/syshosp/Firebird_32.exe /home/sti/Downloads/ && wine /home/sti/Downloads/Firebird_32.exe"
	...
	"
	#cp /home/sti/.wine/system.reg /usr/local/etc/wine.systemreg
    #ln -sf /usr/local/etc/wine.systemreg /home/sti/.wine/system.reg
